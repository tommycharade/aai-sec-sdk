...
| P0-12 | Assurance package | Partial | Apache-2.0 project; SBOM/release provenance; current stable-version security policy; machine-validated customer assurance manifest with technical owner and maximum-120-day review; public critical/high acknowledgement, assessment, affected-customer notification and remediation targets; approved technical guarantees/non-guarantees; data-processing/subprocessor disclosure; honest penetration-test/SOC 2/ISO status and roadmap | Approve legal entity, DPA, final subprocessors and contractual terms; run and retain critical/high vulnerability tabletop evidence; commission an independent penetration test and resolve every critical/high finding; complete qualified framework mapping and independent certification work |
