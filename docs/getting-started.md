...
The SDK is being built in public. Until the runtime package is available, clone the repository and validate the project foundation:
...
4. Handle structured allow, deny, approval, and retryable outcomes.
